 ...
 * number in the text field can be incremented or decremented by a configurable
...
public class Spinner extends HBox {
    ...
    public static final String NUMBER_FIELD = "tb8";
    ...
    private SpinnerTextField numberField;
    ...
    public Spinner(Integer value, Integer stepWidth) {
        this(value, stepWidth, NumberFormat.getInstance());
        tempValue = value;
    }
    
    public Spinner(Integer value, Integer stepWidth, Integer maxValue) {
        this(value, stepWidth, NumberFormat.getInstance());
        tempValue = value;
        this.maxValue = maxValue;
    }    

    public Spinner(Integer value, Integer stepWidth, NumberFormat nf) {
        super();
        this.setId(NUMBER_SPINNER);
        this.stepWitdhProperty.set(stepWidth);

        // TextField
        numberField = new SpinnerTextField(value, nf);
        numberField.setEditable(false);
        numberField.setPrefSize(170, 25);
    ...
    private void increment() {
        ...
        if (value <= maxValue) {
            ...
            numberField.setNumber(maxValue);
        }
    }
    ...
    private void decrement() {
        ...
        if (value >= tempValue) {
            ...
            numberField.setNumber(tempValue);
        }
    }
